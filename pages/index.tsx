...
const Home = ({tvDiscover, movieDiscover, todayAll,bestRate}:Props) => {
  ...
  return (
    <div className='relative bg-gradient-to-b  h-full bg-gradient-to-b from-gray-900/10 to-[#010511] lg:h-[140vh]'>
      <Head>
        <title>Netflix</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="https://i.pinimg.com/736x/da/f3/0f/daf30fac5e16393d66a3684dd27e29af.jpg" />
      </Head>
    ...
    <Row category={bestRate} title="Les mieux notés" />
